...
const home = `<section class="hero wrap"><div class="hero-top"><p class="eyebrow"><span class="green-dot"></span> INDEPENDENT SOFTWARE PORTFOLIO</p><span class="edition">SELECTED WORK / 01—03</span></div><h1>Ý tưởng thực tế.<br>Phần mềm <span class="serif">hữu ích.</span><span class="hero-asterisk" aria-hidden="true">✳</span></h1><div class="hero-bottom"><p>Tôi xây dựng các giải pháp cho giáo dục,<br class="desktop-br"> tự động hóa nội dung và công cụ dữ liệu.<br class="desktop-br"> Khám phá chức năng và công nghệ phía sau mỗi dự án.</p><a class="button dark" href="#du-an">Khám phá dự án <span>↘</span></a></div><div class="hero-foot"><span>WEB APPLICATIONS</span><span>AI & AUTOMATION</span><span>DESKTOP SOFTWARE</span><span class="scroll-note">CUỘN ĐỂ KHÁM PHÁ ↓</span></div></section>
<section class="work wrap" id="du-an"><div class="section-heading"><div><p class="eyebrow">01 / DỰ ÁN TIÊU BIỂU</p><h2>Những điều đã xây dựng<span class="count">(03)</span></h2></div><p>Mỗi dự án, một bài toán.<br>Mỗi công nghệ, một vai trò.</p></div><div class="filters" role="group" aria-label="Lọc dự án" hidden><button type="button" class="active" data-filter="all" aria-pressed="true">Tất cả <span>03</span></button><button type="button" data-filter="web" aria-pressed="false">Web application</button><button type="button" data-filter="ai" aria-pressed="false">AI & tự động hóa</button><button type="button" data-filter="desktop" aria-pressed="false">Desktop</button></div><p class="sr-only" id="filter-status" role="status" aria-live="polite"></p><div class="project-grid">${projects.map(card).join('')}</div></section>
...
console.log('Built homepage, 3 project articles, 404 and SEO files in dist/');
